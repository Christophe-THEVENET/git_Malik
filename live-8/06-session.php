...
var_dump($_SESSION); // Warning: Undefined variable $_SESSION elle n'est pas créée par défaut
//il faut utiliser la fonction session_start() pour créer la superglobale 
// tableau vide 
