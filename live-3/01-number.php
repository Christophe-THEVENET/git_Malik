...
var_dump($soustraction, $multiplication, $division); // ca fait un retour a la ligne
...
var_dump($resteEntier); // 0

// 10 / 3 => valeur 3 reste entier 1

$resteEntier2 = 10 % 3;

var_dump($resteEntier2); // 1
...
// post incrémentation 
$largeur = 30;
$a = $largeur++; // la ligne d apres sera incrémentée
var_dump($a, $largeur); // 30 31 


// pré incrémentation
$hauteur = 12;
$b = ++$hauteur; // incrémenation immédiate
